        ...
        <div class="py-8">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                    ...
                    {{--
                        IMPORTANTE: Adicionei o ID 'update-accommodation-form' aqui.
                        Este formulário contém apenas os campos e é fechado ANTES dos botões de ação.
                    --}}
                    <form id="update-accommodation-form" action="{{ route('admin.accommodations.update', $accommodation) }}" method="POST" class="p-6 space-y-6">
                        @csrf
                        @method('PUT')
                    ...
                    <div class="px-6 py-4 bg-gray-50 dark:bg-gray-900 border-t border-gray-100 dark:border-gray-700 flex flex-col sm:flex-row justify-between gap-4">
                        <div class="flex gap-3">
                            ...
                            {{--
                                FORMULÁRIO DE TOGGLE STATUS
                                Isolado aqui para não entrar em conflito com o form principal.
                            --}}
                            <form action="{{ route('admin.accommodations.toggle-status', $accommodation) }}" method="POST">
                                @csrf
                                @method('PATCH')
                                <button type="submit"
                        ...
                        <div class="flex gap-3">
                            ...
                            {{--
                                BOTÃO DE GUARDAR
                                O atributo form="update-accommodation-form" liga este botão ao formulário lá em cima.
                            --}}
                            <button type="submit" form="update-accommodation-form"
